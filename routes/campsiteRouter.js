...
// Comment routing for specific campsite
...
// Specific comment routing for specific campsite
    ...
    .then(campsite => {
        if (campsite && campsite.comments.id(req.params.commentId)) {
            ...
            if (req.user._id.equals(comment.author)) {
                ...
                err = new Error(`You are not the author of comment ${req.params.campsiteId}`);
                err.status = 403;
                return next(err);    
            }
        } 
